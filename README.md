...
| LED | State |
|---|---|
| Amber | Waiting to pair |
| Blue, slow flashing | Scanning for the radio |
| Blue, breathing | Radio connected; waiting for iOS |
| Blue, solid | Radio and iOS connected |
| Amber, fast flashing | Entering deep sleep |
| Red, slow flashing | Fatal error; reset required |
